...
async function flushUpdate(ctrl, props, isLoop) {
  ...
  if (onResolve) {
    shared.raf.batchedUpdates(() => onResolve(result));
  }
  return result;
}
...
function useTransition(data, props, deps) {
  ...
  reactLayoutEffect.useLayoutEffect(() => shared.each(expired, ({ctrl, item, key}) => {
    detachRefs(ctrl, ref);
